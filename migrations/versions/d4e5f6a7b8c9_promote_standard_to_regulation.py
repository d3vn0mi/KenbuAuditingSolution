...
def upgrade():
    ...
    op.execute('ALTER TABLE audit_sessions RENAME CONSTRAINT fk_audit_sessions_standard TO fk_audit_sessions_regulation')


def downgrade():
    op.execute('ALTER TABLE audit_sessions RENAME CONSTRAINT fk_audit_sessions_regulation TO fk_audit_sessions_standard')
